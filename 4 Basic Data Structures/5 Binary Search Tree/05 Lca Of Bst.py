...
def find_lca(start_node, val1, val2):
    if val1 < start_node.data and val2 < start_node.data:
        return find_lca(start_node.left, val1, val2)
    elif start_node.data < val1 and start_node.data < val2:
        return find_lca(start_node.right, val1, val2)
    else:
...
if __name__ == '__main__':
    ...
    print(find_lca(root, int(input()), int(input())))
