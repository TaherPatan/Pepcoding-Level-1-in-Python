...
def replace_with_larger(start_node):
    global max_sum
    if not start_node:
        return
    replace_with_larger(start_node.right)
    start_node.data, max_sum = max_sum, start_node.data + max_sum
    replace_with_larger(start_node.left)
