...
def transform_to_normal_tree(start_node):
    if not start_node:
        return
    transform_to_normal_tree(start_node.left.left)
    transform_to_normal_tree(start_node.right)
