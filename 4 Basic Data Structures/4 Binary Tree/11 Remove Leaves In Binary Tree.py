...
def remove_leaves(start_node):
    if not start_node:
        return
    if start_node.left:
        if not (start_node.left.left or start_node.left.right):
            start_node.left = None
    if start_node.right:
        if not (start_node.right.left or start_node.right.right):
            start_node.right = None
    remove_leaves(start_node.left)
    remove_leaves(start_node.right)
